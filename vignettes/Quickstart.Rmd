...
The package contains some toy datasets that are used in the rest of this package. Full support files that are suitable for use with data from [Javierre et al.](http://dx.doi.org/10.1016/j.cell.2016.09.037) can be downloaded using the following command

`curl -s https://www.immunobase.org/downloads/rCOGS/rCOGS_extdata.tgz | tar -xvz`
